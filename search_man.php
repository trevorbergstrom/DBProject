...
<div class="container">
  ...
  <div class="col-lg-12 text-center">
    <?php
      $man_id = $_POST['man'];
      $imgq= "SELECT logo FROM Manufact WHERE m_id=".$man_id;
      $imgsql= mysqli_query($conn, $imgq);
      $imgrow= mysqli_fetch_array($imgsql);
      echo '<img src="'.$imgrow['logo'].'" class="img-fluid" alt="Responsive image"> <br/>';
    ?>
    <div class="col-lg-12 text-center">
      <h2> Results </h2>
      <table class='table'>
        ...
        <?php
          $man_id = $_POST['man'];
          $query= "SELECT a.ac_id as aid, m.name as mname, a.Designation as ad, a.NATO_name as nn, a.img_link as pic FROM Aircraft as a JOIN Manufact as m USING(m_id)"; 
          if($man_id != "all") {
            $query= $query.' WHERE m_id='.$man_id;
          }
